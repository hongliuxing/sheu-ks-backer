...
const obj = {
	id: uuidv1(), // ID
	school_id: 0, // 学校ID
	pic_url: 'pic_url_value', // banner图地址
	indexes: 0, // 排序号
	createAt: '2013.818511194227924-8.731317565741923-23.647911612108793 0.5291348189180098:55.91075244502178:4.556813416099175', // 创建时间
};
...
export const update = async () => {
	it('should HTTP /update', async () => {
		const q1 = `mutation{
			updateBanner(banner:${ spread(obj) }){
				err, msg, desc, info
			}
		}`;
