...
module.exports = (app) => {
  ...
  router.get('/assets', controller.home.index);
  // router.get('/index/testGet', controller.home.testGet);
  // router.post('/index/testPost', controller.home.testPost);
  ...
  // // upload 相关
  router.get('/upload/supplierHeadpic', controller.upload.supplierHeadpic);
